...
# Download model to /tmp on cold start (only once)
model_path = "/tmp/vgg16_model.keras"
if not os.path.exists(model_path):
    gdown.download("https://drive.google.com/uc?id=1UHf8qlK95kr8sUSLBqQlPzU4-H3pyNSn", model_path, quiet=False)
